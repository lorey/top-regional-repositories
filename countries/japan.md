...
These are the repositories with the highest ratio of stars from programmers based in Japan:
...
- [open-wripe](https://github.com/masuidrive/open-wripe): https://wri.pe source code
